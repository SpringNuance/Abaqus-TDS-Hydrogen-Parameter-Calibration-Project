...
def main_run_iteration_sims(global_configs, stage2_outputs, stage3_outputs, 
    ...
    initial_TDS_measurements = stage3_outputs["initial_TDS_measurements"]
    ...
    GP_model = stage5_outputs["GP_model"]
    ...
    while True:
        ...
        model_dirs = glob.glob(f"{models_path}/LSTM/iteration_*/{model_name}")
        ...
        for objective in objectives: 
            ...
            if not os.path.exists(f"{results_iter_common_path}/{objective}/FD_curves_iteration_{iteration_index}.npy"):
                ...
                input_file_name = input_file_name[objective]
        ...
        if not os.path.exists(f"{models_path}/LSTM/iteration_{iteration_index}/{model_name}"):
