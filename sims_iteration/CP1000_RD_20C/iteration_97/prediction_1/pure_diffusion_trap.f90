...
subroutine UMATHT(u,dudt,dudg,flux,dfdt,dfdg, &
    ...
    ! NL = 6.02214 Ã— 10e23 [atom/mol] * 7900 [kg/m**3] / (55.85 * 10e-3 [kg/mol]) = 8.518e28 [atom/m**3]
    ...
    statev(10) = CL_wtppm
    statev(11) = CT_wtppm
    statev(12) = CT_dis_wtppm
    statev(13) = CT_gb_wtppm
    statev(14) = CT_carb_wtppm
    statev(15) = thetaL
    statev(16) = thetaT_dis
    statev(17) = thetaT_gb
    statev(18) = thetaT_carb
